...
class MASForm1_Validator:
    ...
    def compare_f1(self):
        ...
        merged_f1 = merged_f1[['Client - Amount_check', 'Client - Subtotal_check',
                               'RSM - Amount_check', 'RSM - Subtotal_check',
                               'Variance - Amount_check', 'Variance - Subtotal_check'
                               ]
                               ]
        
        self.merged_f1_detailed = merged_f1
        # self.merged_f1_summary = merged_f1.groupby([]).agg({'Client - Amount_check' : 'sum',
        #                                                             'Client - Subtotal_check' : 'sum',
        #                                                             'RSM - Amount_check' : 'sum',
        #                                                             'RSM - Subtotal_check' : 'sum',
        #                                                             'Variance - Amount_check' : 'sum',
        #                                                             'Variance - Subtotal_check' : 'sum',
        #                                                             })
...
if __name__ == '__main__':
    ...
    fp = r"D:\workspace\luna\personal_workspace\gold_standard\mas_forms" + f"\mas_form1_formatted_{client_code}_{fy}.xlsx"

    self = MASForm1_Validator(gold_fp = fp,
                              input_fp = fp)
