...
# Load form 1 output
from luna.lunahub.tables.fs_masf1_output import (
    MASForm1Output_LoaderToLunaHub,
    MASForm1Output_LoaderFromLunaHub
    )

class MASForm2Output_LoaderToLunaHub(MASForm1Output_LoaderToLunaHub):

    TABLENAME = "fs_masf2_output"
    ...
    def __init__(self, 
        ...
        Input df0:
            - Option 1 with the following columns:
                ['Header 1', 'Header 2', 'Header 3', 'Header 4', 'Header 5', 
                 'Amount', 'Subtotal', 'var_name', 'Has value?', 
                 'L/S', 'L/S (intervals)',
                 'Balance']
        ...
        self.fy            = fy
        self.tablename     = MASForm2Output_LoaderToLunaHub.TABLENAME
    ...
    def process_data(self):
        ...
        # Options
        option1 = [
            'Header 1', 'Header 2', 'Header 3', 'Header 4', 'Header 5', 'Amount',
            'Subtotal', 'var_name', 'Has value?', 'L/S', 'L/S (intervals)',
            'Balance'
            ]
        option2 = ["var_name", "Amount", "Subtotal", "Balance", "L/S"]
        
        # Filter
        df_processed = df0[option2].dropna(subset=['var_name'])
...
class MASForm2Output_LoaderFromLunaHub(MASForm1Output_LoaderFromLunaHub):
    ...
    def __init__(self, client_number, fy, lunahub_obj=None):
        ...
        self.fy             = int(fy)
        self.tablename      = MASForm2Output_LoaderFromLunaHub.TABLENAME
    ...
    def main(self):
        ...
        if df is not None:
            ...
            column_mapper = {
                v: k 
                for k, v in MASForm2Output_LoaderToLunaHub.COLUMNMAPPER.items()
                }
...
if __name__ == "__main__":
    ...
    if False:
        ...
        fp = r"D:\Desktop\owgs\CODES\luna\personal_workspace\form1\output.df"
        df0 = pd.read_pickle(fp)
        
        client_number = 1
        fy = 2022
        
        self = MASForm2Output_LoaderToLunaHub(df0, client_number, fy)
        self.main()
    ...
    if True:
        ...
        client_number = 1
        fy = 2022
        self = MASForm2Output_LoaderFromLunaHub(client_number, fy)
        df = self.main()
