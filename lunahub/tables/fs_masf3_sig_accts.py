...
class MASForm3SigAccts_DownloaderFromLunaHub:
    
    TABLENAME = "fs_masf3_sigaccts"
    ...
    def main(self):
        ...
        if df is not None:
            ...
            column_mapper = {
                v: k 
                for k, v in MASForm3SigAccts_DownloaderFromLunaHub.COLUMN_MAPPER.items()
                }
...
if __name__ == "__main__":
    ...
    if True:
        ...
        uploaddatetime = None
        lunahub_obj = None
        self = MASForm3SigAccts_DownloaderFromLunaHub(client_number,
                                                          fy,
                                                          lunahub_obj)
