...
class MASForm1Output_LoaderToLunaHub(LunaHubBaseUploader):
    ...
    def __init__(self, 
        ...
        self.fy            = fy
        self.tablename     = "fs_masf1_output"
...
class MASForm1Output_LoaderFromLunaHub:
    ...
    def main(self):
        ...
        if df is not None:
            ...
            column_mapper = {
                v: k 
                for k, v in MASForm1Output_LoaderToLunaHub.COLUMNMAPPER.items()
                }
...
if __name__ == "__main__":
    ...
    if False:
        ...
        self = MASForm1Output_LoaderToLunaHub(df0, client_number, fy)
        self.main()
    ...
    if True:
        ...
        client_number = 1
        fy = 2022
        self = MASForm1Output_LoaderFromLunaHub(client_number, fy)
        df = self.main()
