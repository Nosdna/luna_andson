...
if __name__ == "__main__":
    ...
    if True:
        ...
        tb_fp = r"D:\gohjiawey\Desktop\Form 3\Myer Gold Investment Management - 2022 TB.xlsx"
    ...
    if True:
        ...
        # Load the class
        mapper_class = MASTemplateReader_Form1(mas_tb_mapping_fp, sheet_name = "Form 1 - TB mapping")
